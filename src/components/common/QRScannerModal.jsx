  ...
  useEffect(() => {
    ...
    scanner.render(
      (decodedText) => {
        ...
        // If scanned content looks like ISBN or Book ID, redirect to catalog/book page
        setTimeout(() => {
      ...
      (errorMessage) => {
        // Ignored minor scanning frame warnings
      }
    );
        ...
        <div className="bg-slate-950 rounded-xl p-2 border border-slate-800 overflow-hidden min-h-[300px] flex items-center justify-center">
          {scanResult ? (
            <div className="text-center p-6 space-y-3">
              ...
              <h4 className="text-base font-semibold text-white">QR Code Scanned!</h4>
              <p className="text-xs font-mono bg-slate-900 px-3 py-2 rounded text-emerald-400 border border-emerald-500/20 break-all">
                {scanResult}
              </p>
