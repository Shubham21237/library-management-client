        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-300 rounded-xl pl-11 pr-4 py-2.5 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition-colors text-xs font-medium"
            />
          </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {books.map((book) => (
            <div
              key={book._id}
              className="glass-card overflow-hidden group flex flex-col hover:border-slate-300 transition-all duration-300"
            >
              {/* Book Cover Image */}
