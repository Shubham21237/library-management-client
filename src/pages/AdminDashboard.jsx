  ...
  return (
    <div className="max-w-[96%] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card p-5 border-amber-200 bg-amber-50/40">
        ...
        <div className="glass-card p-5 border-emerald-200 bg-emerald-50/40">
        ...
        <div className="glass-card p-5 border-indigo-200 bg-indigo-50/40">
        ...
        <div className="glass-card p-5 border-purple-200 bg-purple-50/40">
      ...
      {isAddBookModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md w-screen h-screen top-0 left-0">
          <div className="glass-card w-full max-w-2xl p-6 relative max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-4 rounded-xl bg-indigo-50/80 border border-indigo-200 mb-6 space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-grow bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-900 focus:outline-none focus:border-indigo-500"
                />
                <button
                  type="button"
